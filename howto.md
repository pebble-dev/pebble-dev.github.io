...
* To enable health, tap *Enable*. Then, tap *Agree*.
* Choose your settings for health, then tap *Continue*.
...
* Don't grab apps yest, tap the arrow in the upper right corner.
* You're done. Well, the Pebble part is done. Tap *done*.
